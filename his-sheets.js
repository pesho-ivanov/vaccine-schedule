  ...
  "change_notes": [
    {
      ...
      "changes": [
        "Номенклатура CL038 - спиране на кодове 19, 20, 21, 22, 65, 75, 76",
        "Номенклатура CL150 - промяна в стойността на връзката с МКБ код по CL011на \"M30.1\" за запис с ключ: 1330000271",
        "Номенклатура CL136 - промяна в Description, Display value BG, Display value EN за записи с ключове: 3, 4"
      ]
    },
    {
    ...
    },
    {
      ...
      "changes": [
        "Номенклатира CL998 - добавено съобщение за предупреждение W001 за липсваща партида от ваксина",
        "Номенклатира CL998 - добавено съобщение за предупреждение W002 за недостатъчно количество",
        "Номенклатура CL150 - промяна в стойността на CL011 за рядко заболяване на ред с ключ 0511000089 - МКБ кодът е коригиран от E11 на E11.9"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL038 - добавен код 103 за варицела 1-ви прием",
        "Номенклатура CL038 - добавен код 104 за варицела 2-ри прием",
        "Номенклатура CL038 - добавен код 105 за коклюш при бременни",
        "Номенклатура CL038 - добавен код 106 за РСВ при бременни"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL038 - добавен код 102 за трета доза по новите правила за HPV",
        "Номенклатура CL038 - промяна в правилата за кодове 100 и 101 във връзка с новата HPV програма"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL107 - промяна в стойностите на Description и Language EN за keys: C,Co,Cm,Cd,Cb,Cl,Cc,R,Rc",
        "Номенклатура CL107 - добавени нови кодове: NC,NCo,NCm,NCd,NCb,NCl,NCc,N,Res,DR,DRo,DRm,DRd,DRb,DRl,DRc",
        "Номенклатура CL107 - промяна в стойността на meta.Incompatible other codes from CL107 за keys: H,P,О,Oo,Om,Od,Ob,Ol,Oc,E,B,X,F.I,Re,T",
        "Номенклатура CL107 - промяна в ключа на записи при които ключът е бил изписан на кирилица - заменя се с еквивалент на латиница при стойности с keys: Е, О, К, Т",
        "Номенклатура CL022 - добавени нови кодове: 65-226, 98-012, 98-013, 98-014",
        "Номенклатура CL022 - добавени нови Meta data колони за стойности за: LOINC и SNOMED",
        "Номенклатура CL022 - добавени стойности за meta.LOINC за ключове: 03-002, 03-00C, 03-011",
        "Номенклатура CL024 - добавени нови кодове: 02-00A-03, 02-00A-04, 02-00A-05, 65-226-01, 65-226-02,65-226-03, 65-226-04, 65-226-05, 65-226-06, 65-226-07, 65-226-08, 65-226-09,65-226-10,  98-012-01, 98-012-02, 98-012-03, 98-012-04, 98-012-05, 98-012-06, 98-012-07, 98-012-08, 98-012-09, 98-012-0A, 98-014-01, 98-013-01, 98-013-02, 98-013-03, 98-013-04, 98-013-05, 98-013-06, 98-013-07, 98-013-08, 98-013-09, 98-013-0A, 98-013-0B, 98-013-0C, 98-013-0D, 98-013-0E, 98-013-0F, 98-013-10, 98-013-11, 98-013-12, 98-013-13, 98-013-14, 98-013-15, 98-013-16, 98-013-17",
        "Номенклатура CL024 - добавени нови Meta data колони за стойности за: SNOMED",
        "Номенклатура CL028 - добавени нови Meta data колони за стойности за: Description EN, Label BG, Label EN, а колоната Description се променя на Description BG",
        "Създадена номенклатура CL094 за Разделение на възрастови групи",
        "Номенклатура CL032 - добавени нови кодове: 4, 5",
        "Номенклатура CL032 - добавени нови Meta data колони за стойности за: LOINC и SNOMED",
        "Номенклатура CL032 - добавени нови Meta data колони за стойности за: Description EN, Label BG, Label EN, а колоната Description се променя на Description BG",
        "Номенклатура CL032 - добавени стойности за всички нови Meta data за ключове: 1, 2, 3",
        "Номенклатура CL038 - промяна в стойностите на Display Value BG и Display Value EN за кодове: 84, 85, 86 поради допусната техническа грешка в изписването на поредност на дозите"
      ]
    },
    {
      ...
      "changes": [
        "Създадена номенклатура CL148 във връзка с регистър на Заразните болести",
        "Номенклатура CL011 - добавяне на нови заболявания с кодове: J09, U04, U04.9",
        "Номенклатура CL011 - добавяне на колона към Meta data с информация за това дали конкретния МКБ код е за заразно заболяване - Contagious (релация към CL148)",
        "Създадена номенклатура CL149 за категоризация на случаите на заразни заболявания",
        "Номенклатура CL038 - добавяне на колони към Meta data с информация за имена при мигрирани данни от НЗОК - колони Display transfered data BG и Display transfered data EN",
        "Номенклатура CL038 - добавяне на колона към Meta data с информация за групата на имунизационните програми - Program Group, която преди беше представена като отделни редове и липсваше в данните по отделните кодове",
        "Номенклатура CL018 - добавяне на код 10 за здравен експерт от МОН",
        "Номенклатура CL018 - добавяне на код 11 за инспектор от ИАМН",
        "Създадена номенклатура CL150 за редки заболявания по Orhpanet",
        "Номенклатура CL078 - добавяне на колони към Meta data с информация за описание при редки заболявания - Orpha diseases label BG и Orpha diseases label EN",
        "Номенклатура CL084 - корекция в наименованието на номенклатурата",
        "Номенклатура CL086 - корекция в наименованието на номенклатурата"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL037 - добавена ваксина с код 46255 - Bexsero",
        "Номенклатура CL038 - промяна в данните за код 73 и 74 за следните данни: Dose number (брой дози); Min age; Rules; CL037 Mapping (2025)",
        "Номенклатура CL001 - премахване на записи с код 3 и 4",
        "Създадена номенклатура CL147",
        "Номенклатура CL037 - спиране на кодове: 16568, 15497, 17327 поради смяна на продуктите за противогрипни ваксини",
        "Номенклатура CL037 - добавени ваксини с кодове: 66739 (Vaxigrip), 66737 (Vaxigrip)",
        "Номенклатура CL038 - промяна на кодове за връзка към CL037 - сменят се стойностите за код 99 и 72"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL038 - спиране на кодове 77, 78, 79 и 80 във връзка със стартиране на новата HPV програма и въвеждането на кодове 100 и 101",
        "Номенклатура CL037 - спиране на код 1542 за ваксина Pentaxim поради изтичане на срок на годност на последни закупени партиди до 30.06.2025. Ваксината се заменя от Infanrix-IPV+HIB",
        "Номенклатура CL038 - премахната е връзка към CL037 за кодове 28, 29, 30 и 31 за ваксина 1542 поради спиране на ваксина Pentaxim"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL038 - премахната е връзка към CL037 за кодове 48 и 49, като е премахната възможността за прилагане на код 16979 (Preventar 13) за пневмококови имунизации",
        "Номенклатура CL038 - промяна на стойностите за Min age и Max age при кодове: 28, 29, 30, 44, 61, 62, 63, 64, 70, 74, 98",
        "Номенклатура CL038 - премахнато правило от rules за код 52 по отношение на минимален интервал между дозите",
        "Номенклатура CL038 - промяна в Dose number за код 59, 73, 74, 91, 92, 98",
        "Номенклатура CL038 - при код 81 е премахната връзката към CL037 за код 16074 (Gardasil)",
        "Номенклатура CL037 - възстановен е код 1234 за ваксина Priorix",
        "Номенклатура CL038 - при код 45 е добавена връзката към CL037 за код 1234 (Priorix) за регистиране на случаи по медицински проучвания за ваксината",
        "Номенклатура CL022 - промяна в Description и Display Value EN за кодове: 04-030; 00-02C във връзка с промени в приложение № 10 „Изисквания на НЗОК за сключване на договор с лечебни заведения за оказване на СИМП“",
        "Номенклатура CL022 - добавени нови кодове: 02-029; 0B-04E; 03-029",
        "Номенклатура CL022 - за код 02-024 са добавени стойности за NHIF code и NHIF Package",
        "Номенклатура CL024 - добавени нови кодове: 02-029-00; 0B-04E-00; 03-029-00",
        "Номенклатура CL038 - всички възрасти в Min age и Max age, които са в седмици, са преобразувани в дни. Това включва Min age при кодове: 28, 29, 30 и 70"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL037 - добавена стойност за Target desease за код 64095",
        "Номенклатура CL021 - променен Description и Language EN за код 14 (добавено пояснение, че е Скрийнинг по национална програма)",
        "Номенклатура CL047 - променен Description и Language EN за код 12 (добавено пояснение, че е Скрийнинг по национална програма)",
        "Номенклатура CL038 - промяна на стойностите за Min age и Max age при кодове: 7, 8, 9, 27, 33, 34, 35, 36, 37, 38, 39, 40, 41, 43, 44, 46, 99. Промените са при всички възрасти над 12г. при които минималната възраст е в годината, в която пациентът навършва възрастта. Увеличен е периодът, така че да не сработват контроли при лица, които са гранично родени в началото и края на календарна година."
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL132 - промяна на стойност за Max age при преглед A2M20, A2M25 и A8M68 - намаляват се с 1 година, тъй като се горната възрастова граница е до годината, в която се навършва възрастта и се удължават събитията",
        "Добавен код \"03-028\" в номенклатура CL022",
        "Добавен код \"03-028-00\" в номенклатура CL024",
        "Добавени кодове 9, 10, 11 в номенклатура CL002",
        "Добавен код 4 в номенклатура CL055",
        "Добавени кодове 100, 101 в номенклатура CL038 за новите правила за HPV",
        "Промяна на descr и min age при код 81 в номенклатура CL038",
        "Създадена номенклатура CL146"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL132 - промяна на стойност за Event trigger при прегледи J17 и A1 на \"от/до навършване на възрастта\" с цел да няма застъпване на събития при преходни вързрасти",
        "Номенклатура CL038 - промяна на стойностите за Min age и Max age при кодове: 16, 17, 18, 43, 44, 48, 49, 73, 82, 83, 84, 85, 86. Всички възрасти, които са записани в седмици (weeks) са преобразувани в дни, за да може да се считат до дни включително (примерно 20 weeks = 20 * 7 + 6 дни за до края на 20-тата седмица = 146)",
        "Номенклатура CL037 - за код 3339 (Infanrix-IPV+HIB) е променена стойността на number of doses от 3 на 4"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL132 - добавена стойност за Max age при преглед A5M, за да няма застъпване с дейностите по A10M",
        "Номенклатура CL018 - добавен код 9 за медицинска експертиза"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL038 - добавена нова ваксина по CL037 - 57335 за кодове: 48, 49 и 51",
        "Номенклатура CL044 - добавени са всички ЕКАТТЕ записи към публичната номенклатура. Включени са към номенклатурата всички селищни образувания",
        "Номенклатура CL007 - премахнати грешно дублирани записи за Т4 и Т5",
        "Номенклатура CL134 - добавена колона Ask once със стойност тип boolean, с която се посочва дали даден въпрос да се задава повторно, ако веднъж вече е получил отговор, различен от NULL или отрицателен отговор",
        "Номенклатура CL114 - добавен нов лекарствен продукт с код 28724 - Fentanyl Kalceks",
        "Номенклатура CL139 - добавен код 07.99, който да се използва в случай, че битово-санитарните условия са добри",
        "Номенклатура CL037 - добавена стойност за vaccine group за код 57335",
        "Номенклатура CL018 - добавен код 8 за фелдшери във връзка с отделянето им от БАПЗГ"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL139 - промяна в код 07.01 и добавени стойности за кодове от 07.02 до 07.11 - възможни отговори за битово-санитарни условия",
        "Номенклатура CL134 - промяна на Note за код 04.03",
        "Номенклатура CL132 - добавена стойност за Max age при преглед A6M, за да няма застъпване с дейностите по A10M"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL144 - промяна на стойности в колона Units при кодове: 65-226-02, 65-226-08, 98-012-01, 98-012-02, 98-012-04",
        "Номенклатура CL132 - промяна на стойности в колона Max age при код V1",
        "Номенклатура CL132 - добавени стойности в колони Min interval from common index и Max interval from common index указващи минимален и максимален интервал между дози от една и съща група ваксини (групата се хваща по ключа в колона Common index) за кодове: V3, V7, V9",
        "Номенклатура CL038 - добавени нови колони в Meta data със следните наименования: Display value BG и Display value EN, които да се използват при визуализация на данни за поствени ваксини от съответната група",
        "Номенклатура CL132 - промени стойности на Description, Display value Bg и Display value En за код A1M",
        "Номенклатура CL132 - добаве код J1M, включващ изследванията на урина от всички профилактични прегледи от група J*"
      ]
    },
    {
      ...
      "changes": [
        "Добавен запис с код 9 в CL069",
        "Актуализирани данни в CL107 - променени стойности за Language En за кодове: Co, Cm, Cd, Cb, Cl, Cc",
        "Добавени записи в CL037 с кодове: 58090, 64095, 64907",
        "Направени промени в CL038 в колона CL037 Mapping (2024) при кодове: 00, 16, 17, 18, 28, 29, 30, 31, 61, 62, 63, 64, 68, 69",
        "Коригирано заглавие на номенклатура CL0144 на CL144"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL144 - премахната стойност в колона Units при код 99-004-01",
        "Премахнат код S2 в номенклатура CL132",
        "Добавен код S3 в номенклатура CL132",
        "Добавенa стойност за MH code за код \"57335\" в номенклатура CL037",
        "Възстановяване на код 57335 в номенклатура CL037"
      ]
    },
    {
      ...
      "changes": [
        "Добавен код \"01.05\" в номенклатура CL139",
        "Премахнат код \"75-175\" от номенклатура CL142",
        "Номенклатура CL142 е реструктприрана да съдържа само дейности от дългосрочната грижа (т.е. без дейности от CL050)",
        "Премахнат код \"76-168\" от номенклатура CL142",
        "Премахната колона Specialty (CL006) в номенклатура CL142 - преминава в PR001",
        "Създадена номенклатура CL144",
        "Създадена номенклатура CL145",
        "Добавена колона Organization BG / Organization EN в номенклатура CL018"
      ]
    },
    {
      ...
      "changes": [
        "Коригирани текстове в CL110",
        "Променена номенклатура CL112 в съответствие с новата наредба за зъболекарските дейности. Старите кодове остават валидни до 1.12.2024"
      ]
    },
    {
      ...
      "changes": [
        "Добавен нов ред \"00-030\" в номенклатура CL022",
        "Добавен нов ред \"00-030-00\" в номенклатура CL024",
        "Към CL088 e добавена колона F с \"CL50 Mapping\" с връзка към номенклатура CL050",
        "Към CL088 е добавени стойности за CL028 Mapping за записи: 75-175-01; 76-168-01",
        "Към CL088 е добавени колона за CL032 Mapping за излседванията, при които CL028 е по номенклатура",
        "Към CL088 е добавени стойности за CL032 Mapping за записи: 75-175-01",
        "Променена номенклатура CL110 в съответствие с новата наредба за зъболекарските дейности. Старите кодове остават валидни до 1.12.2024"
      ]
    },
    {
      ...
      "changes": [
        "Добавена номенклатура CL143",
        "Добавен нов код \"1\" в номенклатура CL143",
        "Добавен нов код \"12\" в номенклатура CL047",
        "Добавен нов код \"14\" в номенклатура CL021",
        "Код \"8\" в номенклатура CL069 става неактивен след 30.09.2024"
      ]
    },
    {
      ...
      "changes": [
        "Добавена номенклатура CL142",
        "Възстановена номенклатура CL050 спрямо версия 1.5.2 на спецификацията",
        "Корекция в nhif_code в номенклатура CL142 за кодове: 11-025, 29-019, 64-120, 60-103",
        "Възстановяване на деактивирани кодове в CL037 - 1754 и 3339",
        "В номенклатура CL038 - добавяне на код 1754 в Meta Data - CL037 за кодове: 16, 17, 18",
        "В номенклатура CL038 - добавяне на код 3339 в Meta Data - CL037 за кодове: 28, 29, 30, 31"
      ]
    },
    {
      ...
      "changes": [
        "Добавен нови кодове: \"D-09-004\" и \"D-09-005\" в номенклатура CL110",
        "Актуализация на Meta Data - \"ACHI Code\" за кодове: 0C-015, 0C-124 и 0C-165 в номенклатура CL022",
        "Коригирано наименование на поле в колона \"C\" ред 17 от номенклатура CL132",
        "Възстановяване на записи от версия 1.2.7 в номенклатура CL050, в това число на кодове: 02-002, 09-019, 10-022, 09-023, 11-025, 14-032, 17-041, 19-043, 19-044, 24-003, 20-006, 20-007, 29-011, 27-016, 29-019, 31-023, 36-037, 36-038, 36-040, 35-041, 47-046, 58-087, 56-088, 60-103, 60-104, 64-119, 64-120, 65-122, 65-135, 65-136, 67-143, 68-146, 68-148, 68-149, 69-150, 69-152, 70-161, 67-189, 71-193, 65-229, 73-231, 73-232, 69-296, 74-305, 74-306, 70-343, 71-350, 71-352, 69-378, 71-384, 71-385, 67-386, 80-389, 79-390, 77-392, 77-396, 77-398, 77-399, 77-401, 77-402, 77-403, 77-404, 59-095, 71-157, 71-388, 71-195, 73-287, 73-288, 73-289, 73-290, 73-291, 70-344, 70-345, 71-346, 71-347, 71-348, 71-349, 73-355, 70-359, 71-383, 71-190, 74-303, 74-304, 28-010, 33-020, 67-387, 71-353",
        "Актуализиране на Description, Display value BG и Display value EN в номенклатура CL132 при всички налични записи",
        "Актуализиране на age и max age при всички ваксини в номенклатура CL132 в това число на кодове: V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12, V13, V14, V15, V16, V17",
        "Изравняване на данните за age и max age с цел записите да са валидни в рамките на календарната година на навършване на възрастта в номенклатура CL132 за кодове: J7, J7M, J8, J9, J10, J10M, J11, J12, J13, J13M, J14, J15, J16, J16M, J17, A30, A31, A32, A33, A34, A35, A36, A37, A38, A39",
        ...
        "Корекция на данни за Display value EN в номенклатура CL132 за кодове: V3, V5, V6, V11, V12, V15",
        "Добавен код 75-390-01 в номенклатура CL088"
      ]
    },
    {
      ...
      "changes": [
        "Добавен нов код \"01.04\" в номенклатура CL139"
      ]
    },
    {
      ...
      "changes": [
        "Добавен нов код \"5\" в номенклатура CL137",
        "Създадена номенклатура CL141",
        "Добавени нови кодове B, C, A, S, V, M, N, T, HC в номенклатура CL102"
      ]
    },
    {
      ...
      "changes": [
        "Добавен нов код \"8\" в номенклатура CL069",
        "Добавен нов код \"4\" в номенклатура CL028",
        "Добавен нов код \"5\" в номенклатура CL028",
        "Добавен нов код \"58717\" в номенклатура CL114",
        "Реконструирана номенклатура CL050",
        "Реконструирана номенклатура CL088",
        "Създадена номенклатура CL126",
        "Създадена номенклатура CL127",
        "Създадена номенклатура CL128",
        "Създадена номенклатура CL130",
        "Създадена номенклатура CL131",
        "Създадена номенклатура CL132",
        "Създадена номенклатура CL133",
        "Създадена номенклатура CL134",
        "Създадена номенклатура CL136",
        "Създадена номенклатура CL137",
        "Създадена номенклатура CL138",
        "Създадена номенклатура CL139",
        "Коригирано наименование на поле в колона \"Е\" ред 9 от номенклатура CL088",
        "Създадена номенклатура CL140",
        "Деактивиране на следните кодове в CL037: 1234, 4084, 16291, 16744, 2683, 16962, 16058, 1754, 3339, 61121, 57335 считано от 17.04.2024",
        "Актуализиране на записи с Key: 16, 17, 18, 23, 24, 25, 26, 27, 28, 29, 30, 31, 48, 49, 51, 00 на колона F в номенклатура CL038"
      ]
    },
    {
      ...
      "changes": [
        "Коригирано наименование на ред 6 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 7 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 8 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 9 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 10 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 11 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 12 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 16 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 17 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 18 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 19 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 20 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 21 колона B  в номенклатура CL107",
        "Коригирано наименование на ред 22 колона B  в номенклатура CL107",
        "Добавен нов код P187.1 в номенклатура CL062",
        "Добавен нов код P187.2 в номенклатура CL062",
        "Добавен нов код P262.1 в номенклатура CL062",
        "Добавен нов код P262.2 в номенклатура CL062",
        "Добавен нов код P265.3 в номенклатура CL062"
      ]
    },
    {
      ...
      "changes": [
        "Добавен нов код 152 в номенклатура CL087",
        "Промяна в наименованието на код 141",
        "Промяна в наименованието на код 142",
        "Заличени 8 броя кодове в номенклатура CL087",
        "Премахнат код \"K\" на ред 32 колона F в номенклатура CL107",
        "Премахнат код \"F\" на ред 24 колона F в номенклатура CL107",
        "Премахнат код \"Е\" на ред 38 колона F в номенклатура CL107",
        "Премахнат код \"S\" на ред 23 колона F в номенклатура CL107",
        "Премахнат код \"D\" на ред 23 колона F в номенклатура CL107",
        "Премахнат код \"Е\" на ред 34 колона F в номенклатура CL107",
        "Коригиранo наименование на ред 6 колона B в номенклатура CL107",
        "Коригиранo наименование на ред 16 колона B  в номенклатура CL107",
        "Промяна в наименованието при код 70 и код 71 в номенклатура CL038",
        "Създадена номенклатура CL135",
        "Коригирано наименование на ред 6 колона C  в номенклатура CL107"
      ]
    },
    {
      ...
      "changes": [
        "Добавена нова колона \"CL037 Mapping (2024)\" към номенклатура CL038 - разликите спрямо 2023 са маркирани в жълто",
        "Код 71 е преместен към Национални програми, преименуван е и е променен броят на дозите в номенклатура CL038",
        "Код 70 е преименуван и е с променен брой на дозите в номенклатура CL038",
        "Прекратен запис -1001 в номенклатура CL037",
        "Прекратен запис -1002 в номенклатура CL037",
        "Прекратен запис -1003 в номенклатура CL037",
        "Прекратен запис -1004 в номенклатура CL037",
        "Прекратен запис -1006 в номенклатура CL037",
        "Прекратен запис 1541 в номенклатура CL037",
        "Прекратен запис 4184 в номенклатура CL037",
        "Прекратен запис 1653 в номенклатура CL037",
        "Прекратен запис 7401 в номенклатура CL037",
        "Прекратен запис 3932 в номенклатура CL037",
        "Добавен код 15210 в номенклатура CL037",
        "Добавен код 57335 в номенклатура CL037",
        "Добавен код 61121 в номенклатура CL037",
        "Коригирано \"Medicament details\" на запис 15497 в номенклатура CL037",
        "Коригирано \"Medicament details\", \"Number of doses\", \"Days to Next Dose\" на запис 16146 в номенклатура CL037"
      ]
    },
    {
    ...
    },
    {
      ...
      "changes": [
        "Добавен код 15497 в номенклатура CL037",
        "Добавен код 15497 в колона \"CL037 Mapping\" за ред 72 на номенклатура CL038",
        "Добавен нов ред в номенклатура CL002 за статус 8 на е-рецепта",
        "Добавен нов ред в номенклатура CL003 за статус 9 на е-направление",
        "Добавен нов ред в номенклатура CL003 за статус 10 на е-направление",
        "Добавена нова колона към Meta Data в номенклатура CL006 - колона Clinical speciality",
        "Създадена номенклатура CL123",
        "Създадена номенклатура CL124"
      ]
    },
    {
      ...
      "changes": [
        "Добавени кодове 545, 546, 547, 548, 549, 550 в номенклатура CL010"
      ]
    },
    {
      ...
      "changes": [
        "Добавен код 6 в номенклатура CL018",
        "Добавен код 7 в номенклатура CL018 (ще влезе в сила след финализиране на интеграцията с регистъра на съсловната организация)",
        "Кодове EC, BC, TE, TB, TG, F са деактивирани в номенклатура CL016 считано от 20.10.2023",
        "Номенкалтура CL009 е напълно актуализирана (за разлика от регулярните incremental updates) - моля синхронизирайте я във вашите софтуери"
      ]
    },
    {
      ...
      "changes": [
        "Добавен код 48571  в колона \"Е\" в Key 77 в номенклатура CL038",
        "Добавен код 48571  в колона \"Е\" в Key 78 в номенклатура CL038",
        "Добавен код 48571  в колона \"Е\" в Key 79 в номенклатура CL038",
        "Добавен код 48571  в колона \"Е\" в Key 80 в номенклатура CL038",
        "Добавен код 48571  в колона \"Е\" в Key 81 в номенклатура CL038",
        "Добавен код \" P123.1 \" в номенклатура CL062",
        "Добавен код \"P123.2\" в номенклатура CL062",
        "Добавен код \"P123.3\" в номенклатура CL062",
        "Добавен код \" P123.4\" в номенклатура CL062",
        "Добавен код \"P248.1\" в номенклатура CL062",
        "Добавен код \"P248.2\" в номенклатура CL062",
        "Добавен код \"P260.1\" в номенклатура CL062",
        "Добавен код \"P260.2\" в номенклатура CL062",
        "Добавен код \"P263.1\" в номенклатура CL062",
        "Добавен код \"P263.2\" в номенклатура CL062",
        "Добавен код \"P265.1\" в номенклатура CL062",
        "Добавен код \"P265.2\" в номенклатура CL062",
        "Коригирана стойност в колона \"Key\" в номенклатура CL998 от \"W001\" става \"Е001\"",
        "Коригирана стойност в колона \"Key\" в номенклатура CL998 от \"W002\" става \"Е002\"",
        "Коригирана стойност в колона \"Key\" в номенклатура CL998 от \"W003\" става \"Е003\"",
        "Коригирана стойност в колона \"Key\" в номенклатура CL998 от \"W004\" става \"Е004\"",
        "Коригирана стойност в колона \"Key\" в номенклатура CL998 от \"W005\" става \"Е005\"",
        "Коригирана стойност в колона \"Key\" в номенклатура CL998 от \"W006\" става \"Е006\"",
        "Коригирана стойност в колона \"Key\" в номенклатура CL998 от \"W007\" става \"Е007\"",
        "Коригирана стойност в колона \"Key\" в номенклатура CL998 от \"W008\" става \"Е008\"",
        "Коригирана стойност в колона \"Key\" в номенклатура CL998 от \"W009\" става \"Е009\"",
        "Добавен код 16146 в номенклатура CL037",
        "Мапинг към код 16146 в колона \"Е\" ред 94 в номенклатура CL038",
        "Добавени кодове \"00-02A\" до \"00-02D\", \"04-02D\", \"04-02E\", \"04-02F\", \"04-030\" в номенклатура CL022",
        "Добавени кодове \"00-02A-00\" до \"00-02D-00\", \"04-02D-00\", \"04-02E-00\", \"04-02F-00\", \"04-030-00\" до \"04-030-17\" в номенклатура CL024",
        "Код \"00-00D\" в номенклатура CL022 става невалиден след 09.10.2023 - използвайте прецизираните кодове \"00-02B\", \"00-02C\" вместо това",
        "Код \"00-00D-00\" в номенклатура CL024 става невалиден след 09.10.2023",
        "Коригирано описанието на \"00-00C\", \"04-014\" в номенклатура CL022",
        "Коригирани описание и стойности за измерване на \"00-00C-00\" в номенклатура CL024",
        "Коригиран изцяло код \"04-014-00\" в номенклатура CL024",
        "Добавен код \"3\" в номенклатура CL032",
        "Добавени кодове \"11\" до \"14\" в номенклатура CL030",
        "Създадена номенклатура CL120",
        "Създадена номенклатура CL121",
        "Създадена номенклатура CL122 (незавършена – да не се използва!)"
      ]
    },
    {
      ...
      "changes": [
        "Създадена номенклатура CL118",
        "Коригирано описанието на ред \"81\" в номенклатура CL038",
        "Добавен ред \"48571\" в номенклатура CL037",
        "Редове \"7401\", \"-1001\", \"-1002\", \"-1003\", \"-1004\" в номенклатура CL037 стават невалидни след 15.09.2023",
        "Добавен ред \"NA\" в номенклатура CL045"
      ]
    },
    {
      ...
      "changes": [
        "Добавен код \"T8\" в номенклатура CL007",
        "Добавен код \"T9\" в номенклатура CL007",
        "Коригирани няколко стойности в CL038,  Key 77,78",
        "Добавен код \"81\" в CL038 ( даваща опция да се добавят и лица извън посочената от имунизация възраст)",
        "Създадена номенклатура CL116",
        "Създадена номенклатура CL117"
      ]
    },
    {
      ...
      "changes": [
        "Променено името на номенклатура CL032",
        "Променено името на номенклатура CL012",
        "Добавени колони за мета данни \"Definition\" и \"Definition EN\" в номенклатура CL012",
        "Премахнат код \"50\" от номенклатура CL038",
        "Променени стойности в колони \"Description\" и \"Dose Number\" за код \"51\" в номенклатура CL038",
        "Добавен код \"Kb\" в номенклатура CL107",
        "Коригирани няколко стойности в колона \"Description\" в номенклатура CL107",
        "Коригирани няколко стойности в колона \"Language EN\" в номенклатура CL107",
        "Коригирани няколко стойности в колона \"Incompatible other codes from CL107\" в номенклатура CL107",
        "Коригирани няколко стойности в колона \"Language EN\" в номенклатура CL111",
        "Променено името на номенклатура CL098",
        "Добавен код \"7\" в номенклатура CL069",
        "Добавени редове \"11-001\" до \"6E-005\" в номенклатура CL022",
        "Добавени редове \"11-001-00\" до \"6E-005-00\" в номенклатура CL024 (подлежат на разширяване и конкретизиране)",
        "Коригирани стойностите в колона \"Incompatible other codes from CL107\" в номенклатура CL107",
        "Създадена номенклатура CL114",
        "Създадена номенклатура CL115"
      ]
    },
    {
      ...
      "changes": [
        "Променена изцяло номенклатура CL110 с нови кодове и различни редове",
        "Променена изцяло номенклатура CL112 с нови кодове и различни редове",
        "Коригирани няколко стойности в колона Description в номенклатура CL107"
      ]
    },
    {
      ...
      "changes": [
        "Коригирана номенклатура CL106 като са премахнати свръхбройните зъби",
        "CL037 - Ваксини - добавена колона N - MH Code",
        "Променена изцяло номенклатура CL107 с нови кодове и различни редове",
        "Променена изцяло номенклатура CL111 с нови кодове и различни редове"
      ]
    },
    {
      ...
      "changes": [
        "Добавяне на код -1006 в номенклатура CL037",
        "Добавена номенклaтура CL103",
        "Добавена номенклaтура CL104",
        "Добавена номенклaтура CL105",
        "Добавена номенклaтура CL106",
        "Добавена номенклaтура CL107",
        "Добавена номенклaтура CL108",
        "Добавена номенклaтура CL109",
        "Добавена номенклaтура CL110",
        "Добавена номенклaтура CL111",
        "Добавена номенклaтура CL112",
        "Добавена номенклaтура CL113",
        "Добавяне на нов код \"D\" в номенклатура CL102"
      ]
    },
    {
      ...
      "changes": [
        "Добавен код 2 в номенклатура CL052",
        "Добавяне на код -1005 в номенклатура CL037",
        "Коригирана колона \"Description\" за редове 3 и 4 в номенклатура CL047",
        "Добавени колони за мета данни в номенклатура CL011",
        "Добавени нови редове \"T6\" и \"T7\" в номенклатура CL007",
        "Добавени преводи на Български в номенклатура CL046",
        "Добавени преводи на Английски в номенклатура CL045"
      ]
    },
    {
    ...
    },
    {
      ...
      "changes": [
        "Добавен код \"1137\" в номенклатура CL006",
        "Добавена номенклaтура CL997",
        "Допълнена номенклатура CL011 с МКБ кодове M70 с пети знак",
        "Попълнена колона \"NHIF Code\" и колона \"NHIF Package\" за редове \"00-027\", \"00-028\", \"00-029\", \"09-007\", \"00-001\" в номенклатура CL022"
      ]
    },
    {
      ...
      "changes": [
        "Добавен код \"6\" в номенклатура CL069",
        "Добавена номенклaтура CL101"
      ]
    },
    {
      ...
      "changes": [
        "Коригирани редове \"<\" и \">\" на \"LT\" и \"GT\" съответно в номенклатура CL097",
        "Променени са стойностите на редове \"391\", \"392\" в номенклатура CL085"
      ]
    },
    {
      ...
      "changes": [
        "Коригирана колона \"NHIF Code\" и колона \"NHIF Package\" за редове \"05-00F\", \"05-00D\" в номенклатура CL022",
        "Променен код \"0\" на \"6\" в номенклатура CL004"
      ]
    },
    {
      ...
      "changes": [
        "Коригирана колона \"CL022 Mapping\" за редове \"0F-112-00\", \"0F-113-00\", \"0F-114-00\", \"0F-115-00\", \"0F-116-00\", \"0F-117-00\", \"0F-118-00\", \"0F-119-00\", \"0F-11A-00\", \"0F-11B-00\", \"0F-11C-00\", \"0F-11D-00\", \"0F-120-00\" в номенклатура CL024",
        "Коригиран код Q90.3 на Q90.9 в номенклатура CL011",
        "Добавен код M94.2 в номенклатура CL011",
        "Добавена номенклaтура CL097",
        "Добавена номенклaтура CL098",
        "Добавена номенклaтура CL099",
        "Добавени нови редове \"00-027\", \"00-028\", \"00-029\" в номенклатура CL022",
        "Добавени нови редове \"00-027-00\", \"00-028-00\", \"00-029-00\" в номенклатура CL024",
        "Промемен ред \"8\" на номенклатура CL060",
        "Добавен нов ред \"9\" в номенклатура CL060",
        "Добавен нов ред \"0\" в номенклатура CL004",
        "Добавена номенклaтура CL100"
      ]
    },
    {
      ...
      "changes": [
        "Добавени нови редове \"02-001-05\", \"02-001-06\", \"02-001-07\", \"02-001-08\", \"02-001-09\", \"04-01A-01\", \"0C-124-00\", \"04-009-01\", \"04-00A-01\", \"04-00B-01\", \"04-00C-01\", \"04-00D-01\", \"04-015-01\", \"04-015-02\", \"04-015-03\", \"04-015-04\", \"04-015-05\", \"0C-015-00\", \"0C-165-00\", \"04-021-01\", \"04-022-01\", \"04-000-01\", \"04-000-02\", \"04-000-03\", \"04-000-04\", \"04-000-05\", \"01-002-F0\", \"04-021-F0\", \"04-022-F0\" в номенклатура CL024",
        "Коригирани изцяло редове \"04-01A-00\", \"0C-121-00\", \"04-015-00\", \"04-009-00\", \"04-00A-00\", \"04-00B-00\", \"04-00C-00\", \"04-00D-00\", \"04-021-00\", \"04-022-00\", \"04-000-00\" в номенклатура CL024",
        "Добавени нови редове \"0C-124\", \"0F-130\", \"0F-131\", \"0F-132\", \"0F-133\", \"0F-134\", \"0F-135\", \"0F-136\", \"0F-137\", \"0F-138\", \"0F-139\", \"0F-13A\", \"0C-015\", \"0C-165\" в номенклатура CL022",
        "Коригирана колона \"Description\" за редове \"0C-121\", \"04-01A\" в номенклатура CL022",
        "Коригирана колона \"NHIF Code\" и колона \"NHIF Package\" за редове \"0C-121\", \"0F-112\", \"0F-113\", \"0F-114\", \"0F-115\", \"0F-116\", \"0F-117\", \"0F-118\", \"0F-119\", \"0F-11A\", \"0F-11B\", \"0F-11C\", \"0C-100\", \"0C-101\", \"0C-102\", \"0C-103\", \"0C-110\", \"0C-111\" в номенклатура CL022",
        "Коригирана колона \"CL022 Mapping\" за редове \"0F-112-00\", \"0F-113-00\", \"0F-114-00\", \"0F-115-00\", \"0F-116-00\", \"0F-117-00\", \"0F-118-00\", \"0F-119-00\", \"0F-11A-00\", \"0F-11B-00\", \"0F-11C-00\" в номенклатура CL024"
      ]
    },
    {
      ...
      "changes": [
        "Комбинирани номенклатури CL021 и CL094 в нова версия на номенклатура CL021",
        "Премахната номенклатура CL094",
        "Допълнена колона \"NHIF Code\" за редове \"0C-121\" в номенклатура CL022",
        "Коригирана колона \"Description\" за редове \"0C-121\" в номенклатура CL022",
        "Коригирани изцяло редове \"0C-121-00\", \"01-000-00\", \"01-000-01\", \"01-000-02\", \"01-000-03\", \"01-000-04\", \"01-000-05\", \"01-000-06\", \"01-000-07\", \"01-000-08\", \"01-000-09\", \"01-000-0A\", \"01-000-0B\", \"01-000-0C\", \"01-001-00\", \"01-001-01\", \"01-001-02\", \"01-001-03\", \"01-001-04\", \"01-001-05\", \"01-001-06\", \"01-001-07\", \"01-001-08\", \"01-00F-00\", \"01-002-00\", \"02-001-00\", \"07-000-00\", \"01-00C-00\", \"01-007-01\", \"0B-040-01\", \"02-007-00\", \"02-002-01\" в номенклатура CL024",
        ...
        "Код \"01-00D-00\" променен на \"01-000-0D\" в номенклатура CL024",
        "Добавени нови редове \"2\" в номенклатура CL032",
        "Добавени нови редове \"4\", \"5\", \"6\", \"7\", \"8\", \"9\", \"10\" в номенклатура CL030"
      ]
    },
    {
      ...
      "changes": [
        "Добавена номенклaтура CL095",
        "Добавена номенклaтура CL096",
        "Добавена обратно колона \"NHIF Package\" в номенклатура CL022 (стойности само за дейности, заплащани от НЗОК)",
        "Добавен нов ред \"01-000-0B\" в номенклатура CL024",
        "Попълнена колона \"CL028 Mapping\" за редове \"01-000-07\", \"01-000-08\", \"01-000-09\", \"01-000-0A\", \"01-005-00\", \"01-006-00\", \"01-007-00\", \"01-00C-00\", \"01-00E-00\", \"01-00F-00\", \"01-011-00\", \"01-012-00\", \"01-015-00\", \"01-013-00\", \"02-005-00\", \"02-007-00\", \"02-023-00\", \"02-026-00\", \"02-028-00\", \"03-000-00\", \"03-009-00\", \"03-01E-00\", \"03-01F-00\", \"03-020-00\", \"03-022-00\", \"03-023-00\", \"03-024-00\", \"03-025-00\", \"03-026-00\", \"04-000-00\", \"08-00A-00\", \"08-00B-00\", \"08-00C-00\", \"08-00D-00\", \"08-00E-00\", \"08-00F-00\", \"08-010-00\", \"08-012-00\", \"08-013-00\", \"08-014-00\", \"08-015-00\", \"08-016-00\", \"09-007-00\", \"09-008-00\", \"09-009-00\", \"09-00A-00\", \"09-00B-00\", \"09-00C-00\", \"09-00D-00\", \"0A-01A-00\", \"0B-04A-00\" в номенклатура CL024",
        "Попълнена колона \"CL032 Mapping\" за редове \"01-000-07\", \"01-000-08\", \"01-000-09\", \"01-000-0A\", \"01-005-00\", \"01-006-00\", \"01-007-00\", \"01-00C-00\", \"01-00E-00\", \"01-00F-00\", \"01-011-00\", \"01-012-00\", \"01-015-00\", \"01-013-00\", \"02-005-00\", \"02-007-00\", \"02-023-00\", \"02-026-00\", \"02-028-00\", \"03-000-00\", \"03-009-00\", \"03-01E-00\", \"03-01F-00\", \"03-020-00\", \"03-022-00\", \"03-023-00\", \"03-024-00\", \"03-025-00\", \"03-026-00\", \"04-000-00\", \"08-00A-00\", \"08-00B-00\", \"08-00C-00\", \"08-00D-00\", \"08-00E-00\", \"08-00F-00\", \"08-010-00\", \"08-012-00\", \"08-013-00\", \"08-014-00\", \"08-015-00\", \"08-016-00\", \"09-007-00\", \"09-008-00\", \"09-009-00\", \"09-00A-00\", \"09-00B-00\", \"09-00C-00\", \"09-00D-00\", \"0A-01A-00\", \"0B-04A-00\" в номенклатура CL024",
        "Попълнена колона \"UCUM\" за редове \"01-000-07\", \"01-000-08\", \"01-000-09\", \"01-000-0A\", \"01-005-00\", \"01-006-00\", \"01-007-00\", \"01-00C-00\", \"01-00E-00\", \"01-00F-00\", \"01-011-00\", \"01-012-00\", \"01-015-00\", \"02-005-00\", \"02-007-00\", \"02-015-00\", \"02-016-00\", \"02-017-00\", \"02-018-00\", \"02-019-00\", \"02-01A-00\", \"02-01B-00\", \"02-023-00\", \"02-026-00\", \"02-028-00\", \"03-000-00\", \"03-009-00\", \"03-01E-00\", \"03-01F-00\", \"03-020-00\", \"03-022-00\", \"03-023-00\", \"03-024-00\", \"03-025-00\", \"03-026-00\", \"04-000-00\", \"08-00A-00\", \"08-00B-00\", \"08-00C-00\", \"08-00D-00\", \"08-00E-00\", \"08-00F-00\", \"08-010-00\", \"08-012-00\", \"08-013-00\", \"08-014-00\", \"08-015-00\", \"08-016-00\", \"09-007-00\", \"09-008-00\", \"09-009-00\", \"09-00A-00\", \"09-00B-00\", \"09-00C-00\", \"09-00D-00\", \"0A-01A-00\", \"0B-04A-00\" в номенклатура CL024",
        "Коригирана колона \"Description\" за редове \"01-001-01\", \"02-00C-00\", \"02-00D-00\", \"02-015-00\", \"02-016-00\", \"02-017-00\", \"02-018-00\", \"02-019-00\", \"02-01A-00\", \"02-01B-00\", \"02-023-00\", \"09-00B-00\", \"03-014-00\" в номенклатура CL024",
        "Добавен нов ред \"01-010-01\" в номенклатура CL024",
        "Коригирана колона \"Description\" за редове \"02-00D\", \"02-015\", \"02-016\", \"02-017\", \"02-018\", \"02-019\", \"02-01A\", \"02-01B\", \"02-023\", \"09-00B\", \"03-014\" в номенклатура CL022",
        "Коригирана колона \"CL028 Mapping\" за редове \"02-010-00\" в номенклатура CL024",
        "Коригирана колона \"CL032 Mapping\" за редове \"02-010-00\" в номенклатура CL024",
        "Коригирана колона \"UCUM\" за редове \"02-010-00\", \"08-001-00\", \"03-024-00\", \"03-025-00\", \"03-009-00\" в номенклатура CL024",
        "Добавен нов ред \"03-023-01\" в номенклатура CL024",
        "Добавен нов ред \"08-018\" в номенклатура CL022",
        "Добавен нов ред \"08-018-00\" в номенклатура CL024",
        "Попълнени стойности в колони \"NHIF Code\" и \"NHIF Package\" за редове \"00-00E\", \"09-00C\", \"06-013\", \"06-011\", \"0F-112\", \"0F-113\", \"0F-114\", \"0F-115\", \"0F-116\", \"0F-117\", \"0F-118\", \"0F-119\", \"0F-11A\", \"0F-11B\", \"0F-11C\" в номенклатура CL022",
        "Допълнена колона \"NHIF Code\" за редове \"0F-120\", \"0F-11D\" в номенклатура CL022",
        "Допълнена колона \"NHIF Package\" за редове \"04-010\" в номенклатура CL022",
        "Добавен нов ред \"0F-11E\" в номенклатура CL022",
        "Добавен нов ред \"0F-121\" в номенклатура CL022",
        "Допълнена колона \"CL022 Mapping\" за редове \"0F-11D-00\", \"0F-120-00\" в номенклатура CL024",
        "Добавен нов ред \"R8\" в номенклатура CL014"
      ]
    },
    {
      ...
      "changes": [
        "Изцяло преработена номенкалтура CL022",
        "Изцяло преработена номенкалтура CL024",
        "Добавена нова колона \"CL032 Mapping\" в номенклатура CL088",
        "Добавен нов ред \"2-00001\" в номенклатура CL050",
        "Добавен нов ред \"2-00001-1\" в номенклатура CL088",
        "Добавен нов ред \"2-00001-2\" в номенклатура CL088",
        "Коригирани стойностите в \"Description\" за редове от \"33\" до \"41\" в номенклатура CL038",
        "Променен код на ред \"5\" на \"6\" в номенклатра CL061",
        "Добавен нов код \"5\" в номенклатура CL061",
        "Коригирани данните в \"Dose Number\" за редове \"04\", \"06\", \"07\" и \"09\" в номенклатура CL038",
        "Добавена номенклaтура CL090",
        "Добавена номенклaтура CL091",
        "Добавена номенклaтура CL092",
        "Добавена номенклaтура CL093",
        "Добавена нова колона \"Usage Instructions\" в номенклатура CL014",
        "Премахната номенклатура CL036",
        "Добавена номенклaтура CL094",
        "Променено описанието \"Description\" и \"Language EN\" на ред \"1\" в номенклатура CL069",
        "Добавен ред \"5\" в номенклатура CL069",
        "Добавена номенклaтура CL998"
      ]
    },
    {
      ...
      "changes": [
        "Добавена номенклaтура CL089",
        "Добавен нов ред \"R6\" в номенклатура CL014",
        "Добавена нова колона \"NHIF Document\" в номенклатура CL014",
        "Добавена нова колона \"NHIF Document\" в номенклатура CL007",
        "Коригирани всички \"Description\" данни в номенклатура CL007",
        "Коригирани всички \"EN Translation\" данни в номенклатура CL007",
        "Коригирани данните в \"Dose Number\" в номенклатура CL038",
        "Коригирани данните в \"Number of Doses\" в номенклатура CL037",
        "Попълнена номенклатура CL062",
        "Попълнена номенклатура CL063",
        "Добавен нов ред \"R7\" в номенклатура CL014"
      ]
    },
    {
      ...
      "changes": [
        "Добавен нов ред в номенклатура CL014 за направление R5",
        "Изцяло преработена номенклатура CL052",
        "Изцяло преработена номенклатура CL051",
        "Коригирани мапинги между CL038 и CL037",
        "Коригирани номера на разрешителни за всички ваксини в CL037",
        "Всички лекарствени продукти в CL037 маркирани като активни (след проверка в НСЦРЛП)",
        "Добавен нов ред \"7401\" в номенклатура CL037",
        "Добавен нов ред \"15358\" в номенклатура CL037",
        "Добавен нов ред \"8556\" в номенклатура CL037",
        "Добавен нов ред \"16887\" в номенклатура CL037",
        "Добавени нови мапинги към CL037 в номенклатура CL038 (спрямо новите редове)"
      ]
    },
    {
      ...
      "changes": [
        "Добавена номенклатура CL083",
        "Коригирани имената на номенклатури CL012, CL022, CL024, CL025",
        "Изцяло преработена номенкалтура CL022",
        "Изцяло преработена номенкалтура CL024",
        "Премахната номенклатура CL068",
        "Добавена номенклатура CL084",
        "Добавена номенклатура CL085",
        "Добавена номенклатура CL086",
        "Добавена номенклатура CL087",
        "Изцяло преработена номенклатура CL037",
        "Актуализирана номенклатура CL038",
        "Добавена колона \"Vaccine Group\" в номенклатура CL037",
        "Добавена колона \"Dose Number\" в номенклатура CL038",
        "Добавена номенклатура CL088",
        "Добавена колона \"Offset Allowed\" в номенклатура CL034",
        "Коригирани описания \"Description\" на всички редове в номенклатура CL013",
        "Коригирани описания \"Description\" на всички редове в номенклатура CL034",
        "Добавена колона \"Medicament Details\" в номенклатура CL037",
        "Премахната колона \"Language EN\" в номенклатура CL038"
      ]
    },
    {
      ...
      "changes": [
        "Попълнена номенлатура CL050 с данни от НЗОК",
        "Добавена колона \"Type\" в номенклатура CL050",
        "Предефинирана номенклатуа CL049 с изцяло нови редове и по FHIR стандарт",
        "Комбинирани номенклатури CL047 с CL048 в нова номенклатура CL047; номенклатура CL048 е изтрита"
      ]
    },
    {
      ...
      "changes": [
        "Добавена номенклатура CL082",
        "Премахната колона \"CL038 Mapping\" от номенклатура CL037",
        "Добавена колона \"CL037 Mapping\" в номенклатура CL038",
        "Добавена колона \"CL082 Mapping\" в номенклатура CL038",
        "Актуализирана номенклатура CL037",
        "Актуализирана номенклатура CL038",
        "Променено описанието (и значението) на редове 05 и 06 в номенклатура CL049"
      ]
    },
    {
      ...
      "changes": [
        "Добавени нови колони \"Quantity\", \"Divisible\", \"Narcotic\", \"Target Disease\", \"Prescription Type\" в номенклатура CL026",
        "Номенклатура CL026 е сведена до няколко примерни реда; данните за тази номенклатура се синхронизират автоматично от НЗОК",
        "Добавени 2 реда с кодове Т4 и Т5 в номенклатура CL007",
        "Коригирани описанията на всички редове в номенклатура CL007",
        "Номенклатура CL009 е сведена до няколко примерни реда; данните за тази номенклатура се синхронизират автоматично от НСЦРЛП",
        "Добавен нов ред в номенклатура CL002 за статус 6 на е-рецепта",
        "Добавен нов ред в номенклатура CL014 за направление R4",
        "Добавен нов ред в номенклатура CL003 за статус 8 на е-направление",
        "Добавена номенклатура CL059",
        "Добавена номенклатура CL060",
        "Добавена номенклатура CL061",
        "Добавена номенклатура CL062",
        "Добавена номенклатура CL063",
        "Добавена номенклатура CL064",
        "Добавена номенклатура CL065",
        "Добавена номенклатура CL066",
        "Добавена номенклатура CL067",
        "Добавена номенклатура CL068",
        "Добавена номенклатура CL069",
        "Добавена номенклатура CL070",
        "Добавена номенклатура CL071",
        "Добавена номенклатура CL072",
        "Добавена номенклатура CL073",
        "Добавена номенклатура CL074",
        "Добавена номенклатура CL075",
        "Добавена номенклатура CL076",
        "Добавена номенклатура CL077",
        "Добавена номенклатура CL078",
        "Добавена номенклатура CL079",
        "Добавена номенклатура CL080",
        "Добавена номенклатура CL081",
        "Добавен нов ред в номенклатура CL002 за статус 7 на е-рецепта"
      ]
    },
    {
      ...
      "changes": [
        "Добавен нов ред с код \"25\" в номенклатура CL024"
      ]
    },
    {
      ...
      "changes": [
        "Добавена нова колона \"Permit Owner ID\" в мета-данните за номенклатура CL037 със стойности за 4-те COVID ваксини",
        "Променено името на колона \"Permit Owner Name\" в мета-данните за номенклатура CL037 и коригирани стойности за 4-те COVID ваксини",
        "Добавена нова колона \"SNOMED\" в мета-данните за номенклатура CL030 със стойности за първите два резултата",
        "Коригиран ред в CL005 - LB Ливан Lebanon",
        "Ред BU в CL005 e направен неактивен",
        "Променено името на колона \"NSCRLP Code\" на \"CL009 Mapping\" в номенклатура CL026",
        "Добавена нова колона \"CL010 Mapping\" в номенклатура CL026",
        "Коригирано описание на ред BQ в номенклатура CL005",
        "Коригирано описание на ред GB в номенклатура CL005",
        "Сменено името на CL056 на \"Медицински инструменти\"",
        "Добавена номенклатура CL057",
        "Добавена номенклатура CL058",
        "Променени редовете по номенклатура CL056 спрямо последните данни от ЕК за DGC. Добавени мета колони \"CL057 Mapping\" и \"CL058 Mapping\"",
        "Добавен нов ред с код \"VNT001\" в номенклатура CL022"
      ]
    },
    {
      ...
      "changes": [
        "Добавени нови редове в CL010",
        "Добавени нови редове в CL035",
        "Номенклатура CL026 обновена с данни от НЗОК към 16.05.2021 - отменените стойности се показват в червено и са с валидност до тази дата",
        "Номенклатура CL009 обновена с данни от НСЦРЛП към 02.05.2021 - отменените стойности се показват в червено и са с валидност до тази дата"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL026 обновена с данни от НЗОК към 16.04.2021 - отменените стойности се показват в червено и са с валидност до тази дата"
      ]
    },
    {
      ...
      "changes": [
        "Добавена номенклатура CL055",
        "Номенклатура CL026 разширена със стойности, които бяха премахнати с ъпдейта от 16.03.2021 - тези редове показват правилно валидност до тази дата и са в червено",
        "Номенклатура CL009 обновена с данни от НСЦРЛП към 02.04.2021 - отменените стойности се показват в червено и са с валидност до тази дата"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL022 обновена с данни от НЗОК към 01.03.2021",
        "Коригирано описание на поле \"senderId\" в съобщение C001",
        "Табове \"Съобщения\", \"С001\", \"С002, \"С003\", \"С004\", \"С099\" са преместени в нов файл с име \"НЗИС Общи Медицински Услуги - API Спецификация\"",
        "Допълнена номенклатура CL056 с тестове за COVID налични в България",
        "Допълнена номенклатура CL011 с новите кодове за COVID",
        "Добавена нова колона \"Mapping to CL038\" в мета-данните за номенклатура CL037",
        "Променено името на ваксина \"COVID-19 Vaccine AstraZeneca\" на \"Vaxzevria\" в номенклатура CL037",
        "Добавен нов ред за ваксина \"COVID-19 Vaccine Janssen\" в номенклатура CL037"
      ]
    },
    {
      ...
      "changes": [
        "Номенклатура CL026 обновена с данни от НЗОК към 16.03.2021",
        "Коригирана номенклатура CL022 (имаше невалидни пакети по НЗОК)"
      ]
    },
    {
      ...
      "changes": [
        "Добавена номенклатура CL051",
        "Добавена номенклатура CL052",
        "Добавена номенклатура CL053",
        "Добавена номенклатура CL054",
        "Добавена номенклатура CL056",
        "Допълнена номенклатура CL022 с нови редове",
        "Премахната номенклатура CL031"
      ]
    },
    {
      ...
      "changes": [
        "Добавени нови редове в номенклатура CL042",
        "Добавени нови редове в номенклатура CL037",
        "Добавена номенклатура CL050",
        "Добавени нови редове в номенклатура CL014",
        "Промемен формата на всички номенклатурни таблици така, че да отговарят по структура на резултата от заявка C001",
        "Поле \"senderISName\" е направено задължително в съобщение C001",
        "Премахнато правило RL008 от съобщение C001 (нерелевантно)",
        "Премахнато условие CD014 от съобщения C001 и C002 (нерелевантно)",
        "Добавено съобщение C003",
        "Добавено съобщение C004"
      ]
    },
    {
      ...
      "changes": [
        "Допълнена номенклатура CL037 с ваксина \"COVID-19 Vaccine AstraZeneca\"",
        "Добавени нови редове в номенклатура CL045",
        "Номенклатура CL031 е маркирана за премахване",
        "Добавена номенклатура CL047",
        "Добавена номенклатура CL048",
        "Добавена номенклатура CL049"
      ]
    },
    {
      ...
      "changes": [
        "Добавена колона Attribute към всички съобщения - по дефаулт стойността е \"value\", отразяваща текущата ситуация",
        "Променено името на поле \"nomenclature.entry.value\" на \"nomenclature.entry.description\" в съобщение C002",
        "Добавена опционална група \"nomenclature.entry.meta\" в съобщение C002",
        "Добавенo задължително поле \"nomenclature.entry.meta.name\" в съобщение C002",
        "Добавенo задължително поле \"nomenclature.entry.meta.value\" в съобщение C002",
        "Добавено опционално поле \"senderISName\" в хедъра на съобщение C001",
        "Добавен нов ред към номенклатура CL043",
        "Добавени мета колони към номенклатура CL037 - Days to Next Dose, Permit Owner, Target Disease",
        "Допълнена номенклатура CL037 с ваксина \"COVID-19 Vaccine Moderna\""
      ]
    },
    {
      ...
      "changes": [
        "Коригиран мапинг към CL022 на ред 10 в номенклатура CL024",
        "Добавена номенклатура CL036",
        "Добавена номенклатура CL035",
        "Добавена номенклатура CL037",
        "Добавена номенклатура CL038",
        "Добавена номенклатура CL039",
        "Добавена номенклатура CL040",
        "Добавена номенклатура CL041",
        "Добавена номенклатура CL042",
        "Добавена номенклатура CL043",
        "Добавена номенклатура CL044",
        "Добавена номенклатура CL045",
        "Добавена номенклатура CL046"
      ]
    },
    {
      ...
      "changes": [
        "Добавени редове 21 - 24 към номенклатура CL024",
        "Добавен мапинг към CL022 в номенклатура CL024",
        "Добавена колона за НЗОК пакет в номенклатура CL022"
      ]
    },
    {
      ...
      "changes": [
        "Отключени съобщенията за извличане на номенклатури",
        "Добавено е поле updateDate в съобщение C001"
      ]
    },
    {
      ...
      "changes": [
        "Добавена номенклатура CL034",
        "Обновена номенклатура CL024 с добавени тестове за МДД 1.40"
      ]
    },
    {
      ...
      "changes": [
        "Добавени преводи и инструкции за употреба в CL016",
        "Добавени преводи CL027",
        "Допълнена номенклатура CL005 с информацията предоставена от НСИ",
        "Допълнена номенклатура CL029 с информацията предоставена от НСИ",
        "Допълнена номенклатура CL020 (добавени стойности за секунда и мнинута) на база  Fhir и НСИ",
        "Актуализиран код на МДД 01.38 - С-реактивен протеин",
        "Добавени държави в CL005",
        "Попълнена номенклатура CL009",
        "Попълнена номенклатура CL026"
      ]
    },
    {
      ...
      "changes": [
        "Коригирани ключовете на номенклатура CL007 на латиница",
        "Коригирана номенклатура CL022 на база анекс между НЗОК и БЛС",
        "Добавени преводи на CL005",
        "Добавени преводи на CL015",
        "Добавени преводи на CL017",
        "Добавени преводи на CL022",
        "Добавени преводи на CL024",
        "Добавени преводи на CL029",
        "Ключовете на номенклатура CL031 са променени да представляват валидни мерни единици по UCUM, тъй като те по своето естество са уникални"
      ]
    },
    {
      ...
      "changes": [
        "Добавени 3 липсващи мапинга към НЗОК за кодове 3088, 2079 и 2081 в номенклатура CL006",
        "Допълнена номенклатура CL006 с информацията последно изпратена от МЗ; добавена колона \"Роля в Здравеопазването\", тъй като много от кодовете имат сходни имена",
        "Добавени стойности на английски за номенклатурa CL021",
        "Добавени стойности на бългaрски за номенклатура CL012",
        "Добавени всички редове от номенклатура CL011. Това значително увеличава размера на файла!",
        "Добавени 2 липсващи стойности към номенклатура CL010 и премахната една дуплицирана стойност"
      ]
    },
    {
      ...
      "changes": [
        "Коригирани мапинги към НЗОК кодове в номенклатура CL006 спрямо последна информация от МЗ",
        "Коригирана номенклатура CL010 спрямо последна информация от МЗ. Това променя индексите от предходната версия!"
      ]
    },
    {
      ...
      "changes": [
        "Премахнати стойности 3127, 3129, 3130, 3133, 3134 и 3136 от номенклатура CL006",
        "Коригирани едноцифрени мапинги към НЗОК код в номенклатура CL006",
        "Добавен ред в номенклатура CL003: 6, Processing",
        "Добавен ред в номенклатура CL003: 7, Partially Executed",
        "Актуализирана номенклатура CL022",
        "Актуализирана номенклатура CL024",
        "Финализирана номенклатура CL031",
        "Добавена номенклатура CL033",
        "Премахната FHIR референция за номенклатура CL013"
      ]
    },
    {
      ...
      "changes": [
        ...
        "Актуализирана номенклатура CL013 спрямо последните данни от МЗ",
        "Сменен статуса на номенклатура CL013 на ФИНАЛИЗИРАНА",
        "Добавен ред в номенклатура CL003: 5, Fetched",
        "Добавен мапинг към НЗОК за номенклатура CL006",
        "Актуализирана номенклатура CL010 спрямо последните данни от МЗ",
        "Сменен статуса на номенклатура CL014 на ФИНАЛИЗИРАНА",
        "Сменено името на номенклатура CL024",
        "Добавена референция към FHIR за номенклатура CL027"
      ]
    }
  ],
  "sheets": [
