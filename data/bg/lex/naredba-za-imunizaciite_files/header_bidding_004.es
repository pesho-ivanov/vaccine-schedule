...
if (hbref == '55297') {
    const jdata = {"hb": "-", "fold": "btf", "gdpr": 50, "manual": {"sound": "0", "auction": "", "players": [""], "autoplay": "0", "instream": "0", "skipable": "0", "outstream": "0", "pricefloor": ""}, "ctr_rate": {"ppc": 0.0000506572781844432, "rtb": 1, "total": 0.0000506572781844432, "ppc_view": 39481, "rtb_view": 0, "ppc_click": 2, "rtb_click": 0}, "gaAdUnitCode": "etarget-id-85947", "viewability_rate": {"total": 0.156133828996283, "mobile": 1, "desktop": 0.152985074626866}};
    //TODO:
    console.log(jdata)
...
if(typeof(window.ethb)=='object'){
    if(typeof(window.ethb.variables)=='object'){
        if(typeof(window.ethb.variables.domain)=='object'){
            if(window.ethb.variables.domain['85947']){
                console.log('HB config for','85947','already exists');
                configExists = true;
            }
        }
    }
...
(function(){
    ...
    window.ethb.que.push(
        {
            setKeyProperty:[
                ['domain','85947','bg'],
                ['supplier','85947','15640'],
                ['globalFallback','85947',''],
                ['globalFallbackType','85947',''],
                ['globalFallbackPubID','85947','-1'],
                ['globalFallbackSlotID','85947',''],
                ['globalFallbackRate','85947',parseFloat('0')],
                ['globalFallbackPrice','85947',parseFloat('0.1')],
                ['globalFallbackPriceFirst','85947',parseFloat('0')],
                ['globalFallbackPrcEtarget','85947','0'],
                ['globalFallbackPrcAdsense','85947','0'],
                ['globalNoFallback','85947',('nofallback'.length>0 ? true : false)],
                ['globalRefreshInterval','85947',parseInt('0')],
                ['globalRefreshScript','85947',''],
                ['fixed_close','85947',''],
                ['fixed_position','85947',''],
                ['fixed_top','85947',''],
                ['fixed_right','85947',''],
                ['fixed_bottom','85947',''],
                ['fixed_left','85947',''],
                ['adapterTimeout','0',parseInt('3000')],
                ['mediatypes','85947',['banner','native']],
                ['refstyling','85947',refstyling],
                ['systemBlockFlag','85947',{
                    ppc:parseInt('0'),
                    etr:parseInt('0'),
                    adf:parseInt('0'),
                    apn:parseInt('0'),
    ...
    window.ethb.que.push(function(){
        window.ethb.init('85947','620','200'); 
        window.ethb.addSizes('85947','620x200,468x60,468x120,300x100'.replace(/ /g,'').replace(/,/g,';').split(';'));
        window.ethb.addSuperOptions('85947');
        var foldPosition = window.ethb.getFold('85947');

        var adapterData = {
            etr:[{
                active: !!('620200'!='1010' && window.ethb.getKeyProperty('85947','systemBlockFlag').etr===0),
                bidder: 'etarget',
                params:{
                    refid:85947,
                    country:6,
            ...
            tds:[{
                active: !!(!parseInt('0') && ''.length>0 && ''.length>0 && window.ethb.getKeyProperty('85947','systemBlockFlag').tds===0),
                bidder: 'teads',
                params: {
                    pageId:'',
                    placementId:''
            ...
            pls:[{
                active: !!(!parseInt('0') && ''.length>0 && window.ethb.getKeyProperty('85947','systemBlockFlag').pls===0),
                bidder: 'pulsepoint',
                params: {
                    cf:'',
                    cp:'',
            ...
            rub:[{
                active: !!(!parseInt('0') && '11352'.length>0 && window.ethb.getKeyProperty('85947','systemBlockFlag').rub===0),
                bidder: 'rubicon',
                params: {
                    accountId: '11352',
                    siteId: '190390',
            ...
            pmt:[{
                active: !!(!parseInt('0') && ''.length>0 && window.ethb.getKeyProperty('85947','systemBlockFlag').pmt===0),
                bidder: 'pubmatic',
                params: {
                    publisherId: '',
                    adSlot: ''
            ...
            svr:[{
                active: !!(!parseInt('0') && ''.length>0 && window.ethb.getKeyProperty('85947','systemBlockFlag').svr===0),
                bidder: 'sovrn',
                params: {
                    tagid: ''
                }
        ...
        adapterCodes['adf'] = '1620343'.split(',');
        adapterCodes['apn'] = '19557324'.split(',');
        for(var k in adapterCodes){
            ...
            for(var j in adapterCode){
                ...
                var fixedSize = '';
                if(code.length>0){
                    var active = !!(!parseInt('0') && code.length>0 && window.ethb.getKeyProperty('85947','systemBlockFlag')[k]===0);
                    var adapter = {};
                    switch(k){
                        case 'adf':{
        ...
        window.ethb.addAdapters('85947',adapterData);
