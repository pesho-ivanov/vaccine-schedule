...
if (hbref == '55297') {
    const jdata = {"hb": "-", "fold": "btf", "gdpr": 50, "manual": {"sound": "0", "auction": "", "players": [""], "autoplay": "0", "instream": "0", "skipable": "0", "outstream": "0", "pricefloor": ""}, "ctr_rate": {"ppc": 0.000215377988369589, "rtb": 1, "total": 0.000215377988369589, "ppc_view": 37144, "rtb_view": 0, "ppc_click": 8, "rtb_click": 0}, "gaAdUnitCode": "etarget-id-85948", "viewability_rate": {"total": 0.220588235294118, "mobile": 1, "desktop": 0.217712177121771}};
    //TODO:
    console.log(jdata)
...
if(typeof(window.ethb)=='object'){
    if(typeof(window.ethb.variables)=='object'){
        if(typeof(window.ethb.variables.domain)=='object'){
            if(window.ethb.variables.domain['85948']){
                console.log('HB config for','85948','already exists');
                configExists = true;
            }
        }
    }
...
(function(){
    ...
    window.ethb.que.push(
        {
            setKeyProperty:[
                ['domain','85948','bg'],
                ['supplier','85948','15640'],
                ['globalFallback','85948',''],
                ['globalFallbackType','85948',''],
                ['globalFallbackPubID','85948','-1'],
                ['globalFallbackSlotID','85948',''],
                ['globalFallbackRate','85948',parseFloat('0')],
                ['globalFallbackPrice','85948',parseFloat('0.1')],
                ['globalFallbackPriceFirst','85948',parseFloat('0')],
                ['globalFallbackPrcEtarget','85948','0'],
                ['globalFallbackPrcAdsense','85948','0'],
                ['globalNoFallback','85948',('nofallback'.length>0 ? true : false)],
                ['globalRefreshInterval','85948',parseInt('0')],
                ['globalRefreshScript','85948',''],
                ['fixed_close','85948',''],
                ['fixed_position','85948',''],
                ['fixed_top','85948',''],
                ['fixed_right','85948',''],
                ['fixed_bottom','85948',''],
                ['fixed_left','85948',''],
                ['adapterTimeout','0',parseInt('3000')],
                ['mediatypes','85948',['banner','native']],
                ['refstyling','85948',refstyling],
                ['systemBlockFlag','85948',{
                    ppc:parseInt('0'),
                    etr:parseInt('0'),
                    adf:parseInt('0'),
                    apn:parseInt('0'),
    ...
    window.ethb.que.push(function(){
        window.ethb.init('85948','620','200'); 
        window.ethb.addSizes('85948','620x200,620x400,468x60,468x120,300x100'.replace(/ /g,'').replace(/,/g,';').split(';'));
        window.ethb.addSuperOptions('85948');
        var foldPosition = window.ethb.getFold('85948');

        var adapterData = {
            etr:[{
                active: !!('620200'!='1010' && window.ethb.getKeyProperty('85948','systemBlockFlag').etr===0),
                bidder: 'etarget',
                params:{
                    refid:85948,
                    country:6,
            ...
            tds:[{
                active: !!(!parseInt('0') && ''.length>0 && ''.length>0 && window.ethb.getKeyProperty('85948','systemBlockFlag').tds===0),
                bidder: 'teads',
                params: {
                    pageId:'',
                    placementId:''
            ...
            pls:[{
                active: !!(!parseInt('0') && ''.length>0 && window.ethb.getKeyProperty('85948','systemBlockFlag').pls===0),
                bidder: 'pulsepoint',
                params: {
                    cf:'',
                    cp:'',
            ...
            rub:[{
                active: !!(!parseInt('0') && '11352'.length>0 && window.ethb.getKeyProperty('85948','systemBlockFlag').rub===0),
                bidder: 'rubicon',
                params: {
                    accountId: '11352',
                    siteId: '190390',
            ...
            pmt:[{
                active: !!(!parseInt('0') && ''.length>0 && window.ethb.getKeyProperty('85948','systemBlockFlag').pmt===0),
                bidder: 'pubmatic',
                params: {
                    publisherId: '',
                    adSlot: ''
            ...
            svr:[{
                active: !!(!parseInt('0') && ''.length>0 && window.ethb.getKeyProperty('85948','systemBlockFlag').svr===0),
                bidder: 'sovrn',
                params: {
                    tagid: ''
                }
        ...
        adapterCodes['adf'] = '1620344'.split(',');
        adapterCodes['apn'] = '19557311'.split(',');
        for(var k in adapterCodes){
            ...
            for(var j in adapterCode){
                ...
                var fixedSize = '';
                if(code.length>0){
                    var active = !!(!parseInt('0') && code.length>0 && window.ethb.getKeyProperty('85948','systemBlockFlag')[k]===0);
                    var adapter = {};
                    switch(k){
                        case 'adf':{
        ...
        window.ethb.addAdapters('85948',adapterData);
