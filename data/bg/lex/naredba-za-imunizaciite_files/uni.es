...
if (hbref == '55297') {
    const jdata = {"hb": "ours", "fold": "btf", "gdpr": 50, "manual": {"sound": "0", "auction": "", "players": [""], "autoplay": "0", "instream": "0", "skipable": "0", "outstream": "0", "pricefloor": ""}, "ctr_rate": {"ppc": 0, "rtb": 0, "total": 0, "ppc_view": 32275, "rtb_view": 136, "ppc_click": 0, "rtb_click": 0}, "gaAdUnitCode": "code_82176_640x120_454", "viewability_rate": {"total": 0.174940898345154, "mobile": 1, "desktop": 0.175355450236967}};
    //TODO:
    console.log(jdata)
...
refstyling.bg = ''.length>0 ? (''=='transparent' ? 'transparent' : '#') : 'transparent';
refstyling.title = {
    color:'000000'.length>0 ? '#000000' : 'black',
    hcolor:'000000'.length>0 ? '#000000' : 'black'
};
refstyling.text = {
    color:''.length>0 ? '#' : 'black',
    hcolor:''.length>0 ? '#' : 'black'
};
refstyling.link = {
    color:''.length>0 ? '#' : 'black',
    hcolor:''.length>0 ? '#' : 'black',
...
if(typeof(window.ethb)=='object'){
    if(typeof(window.ethb.variables)=='object'){
        if(typeof(window.ethb.variables.domain)=='object'){
            if(window.ethb.variables.domain['82176']){
                console.log('HB config for','82176','already exists');
                configExists = true;
            }
        }
    }
...
(function(){
    ...
    window.ethb.que.push(
        {
            setKeyProperty:[
                ['domain','82176','bg'],
                ['supplier','82176','15640'],
                ['globalFallback','82176',''],
                ['globalFallbackType','82176',''],
                ['globalFallbackPubID','82176','-1'],
                ['globalFallbackSlotID','82176',''],
                ['globalFallbackRate','82176',parseFloat('0')],
                ['globalFallbackPrice','82176',parseFloat('0.1')],
                ['globalFallbackPriceFirst','82176',parseFloat('0')],
                ['globalFallbackPrcEtarget','82176','0'],
                ['globalFallbackPrcAdsense','82176','0'],
                ['globalNoFallback','82176',('nofallback'.length>0 ? true : false)],
                ['globalRefreshInterval','82176',parseInt('0')],
                ['globalRefreshScript','82176',''],
                ['fixed_close','82176',''],
                ['fixed_position','82176',''],
                ['fixed_top','82176',''],
                ['fixed_right','82176',''],
                ['fixed_bottom','82176',''],
                ['fixed_left','82176',''],
                ['adapterTimeout','0',parseInt('3000')],
                ['mediatypes','82176',['banner','native']],
                ['refstyling','82176',refstyling],
                ['systemBlockFlag','82176',{
                    ppc:parseInt('0'),
                    etr:parseInt('0'),
                    adf:parseInt('0'),
                    apn:parseInt('0'),
    ...
    window.ethb.que.push(function(){
        window.ethb.init('82176','640','120'); 
        window.ethb.addSizes('82176','620x200,468x60,468x120,300x100'.replace(/ /g,'').replace(/,/g,';').split(';'));
        window.ethb.addSuperOptions('82176');
        var foldPosition = window.ethb.getFold('82176');

        var adapterData = {
            etr:[{
                active: !!('640120'!='1010' && window.ethb.getKeyProperty('82176','systemBlockFlag').etr===0),
                bidder: 'etarget',
                params:{
                    refid:82176,
                    country:6,
            ...
            tds:[{
                active: !!(!parseInt('0') && ''.length>0 && ''.length>0 && window.ethb.getKeyProperty('82176','systemBlockFlag').tds===0),
                bidder: 'teads',
                params: {
                    pageId:'',
                    placementId:''
            ...
            pls:[{
                active: !!(!parseInt('0') && ''.length>0 && window.ethb.getKeyProperty('82176','systemBlockFlag').pls===0),
                bidder: 'pulsepoint',
                params: {
                    cf:'',
                    cp:'',
            ...
            rub:[{
                active: !!(!parseInt('0') && '11352'.length>0 && window.ethb.getKeyProperty('82176','systemBlockFlag').rub===0),
                bidder: 'rubicon',
                params: {
                    accountId: '11352',
                    siteId: '190390',
            ...
            pmt:[{
                active: !!(!parseInt('0') && ''.length>0 && window.ethb.getKeyProperty('82176','systemBlockFlag').pmt===0),
                bidder: 'pubmatic',
                params: {
                    publisherId: '',
                    adSlot: ''
            ...
            svr:[{
                active: !!(!parseInt('0') && '1010795'.length>0 && window.ethb.getKeyProperty('82176','systemBlockFlag').svr===0),
                bidder: 'sovrn',
                params: {
                    tagid: '1010795'
                }
        ...
        adapterCodes['adf'] = '1620342'.split(',');
        adapterCodes['apn'] = '15739846'.split(',');
        for(var k in adapterCodes){
            ...
            for(var j in adapterCode){
                ...
                var fixedSize = '';
                if(code.length>0){
                    var active = !!(!parseInt('0') && code.length>0 && window.ethb.getKeyProperty('82176','systemBlockFlag')[k]===0);
                    var adapter = {};
                    switch(k){
                        case 'adf':{
        ...
        window.ethb.addAdapters('82176',adapterData);
